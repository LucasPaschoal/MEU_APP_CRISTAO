...
class _LeituraBiblicaTelaState extends State<LeituraBiblicaTela>
  ...
  Future<void> _exibirVersiculoCapitulo(LivroBiblico livro, int capitulo) async {
    showDialog(
      context: context,
    ...
    try {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              "Tradução: ${versiculos[0].translation}",
                              style: const TextStyle(
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
                                color: Colors.indigo,
                      ...
                      ...versiculos.map((versiculo) {
                        ...
                        final versiculoNumero = versiculo.reference.split(':').last;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Erro ao buscar versículos: $e'),
          ),
        );
      }
    }
